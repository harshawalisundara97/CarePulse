                ...
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(onClick = onBack) {
                            Icon(Icons.AutoMirrored.Filled.ArrowBack, contentDescription = stringResource(com.carepulse.app.R.string.common_back), tint = MaterialTheme.colorScheme.onSurface)
                        }
                    },
