...
/**
 * Rounded, friendly system typography. Uses the platform's default which on
 * modern Android is well-spaced and readable — keeps the app warm without
 * shipping a custom font file.
 */
val CarePulseTypography = Typography(
    displaySmall = TextStyle(fontFamily = FontFamily.SansSerif, fontWeight = FontWeight.Bold,    fontSize = 32.sp, letterSpacing = (-0.5).sp),
